    ...
    <div className='space-y-4'>
      ...
      <div className='flex gap-2'>
        <input
          ...
          className='flex-1 px-3 py-2 text-sm rounded-lg border border-gray-300 focus:ring-1 focus:ring-blue-500'
        ...
        <button
          ...
          className='flex items-center gap-2 px-4 py-2 text-sm bg-blue-400 
            text-white rounded-lg hover:bg-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed'
        >
      ...
      {data.length > 0 ? (
        <div className='flex flex-wrap gap-2'>
          {data.map((skill, index) => (
            <span key={index} className='flex items-center gap-1 px-3 py-1 bg-blue-300 text-blue-700 rounded-full text-sm'>
              {skill}
              <button
